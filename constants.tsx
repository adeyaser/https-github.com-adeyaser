...
export const MOCK_TEACHERS = [
  MOCK_USER,
  {
    ...
    specialization: "Mathematics & Sensorial Specialist"
  },
  {
    user_id: 6,
    full_name: "Ibu Rina Amelia, S.Psi",
    user_type: "teacher",
    profile_picture: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop",
    specialization: "Child Psychology & Language Specialist"
  },
  {
    user_id: 7,
    full_name: "Ibu Siti Sarah, S.Pd",
    user_type: "teacher",
    profile_picture: "https://images.unsplash.com/photo-1554151228-14d9def656e4?w=150&h=150&fit=crop",
    specialization: "Practical Life & Art Specialist"
  }
];
...
export const MENU_ITEMS = [
  ...
  { name: 'Kurikulum', icon: <BookOpen size={20} />, path: '/learning' },
  { name: 'Penilaian', icon: <ClipboardCheck size={20} />, path: '/assessment' },
  { name: 'E-Learning', icon: <Video size={20} />, path: '/elearning' },
  { name: 'Keuangan', icon: <Wallet size={20} />, path: '/finance' },
  { name: 'Galeri', icon: <ImageIcon size={20} />, path: '/gallery' },
...
export const MOCK_ACTIVITIES: DailyActivity[] = [
  ...
  { activity_id: 2, title: 'Mengenal Tekstur Pasir', content: 'Kegiatan sensorial menggunakan pasir kinetik.', activity_date: '2024-03-16', area_id: 2, is_published: true, photos: ['https://images.unsplash.com/photo-1516627145497-ae6968895b74?w=400'] },
  { activity_id: 3, title: 'Belajar Berhitung Kreatif', content: 'Menggunakan bead stair untuk memahami nilai angka 1-10.', activity_date: '2024-03-17', area_id: 3, is_published: true, photos: ['https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=400'] },
  { activity_id: 4, title: 'Membaca Cerita Bersama', content: 'Meningkatkan literasi melalui story telling yang interaktif.', activity_date: '2024-03-18', area_id: 4, is_published: true, photos: ['https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=400'] }
];
...
export const MOCK_FINANCE = [
  { id: 1, student_id: 1, name: 'Alya Putri Ramadhani', month: 'Maret', amount: 500000, status: 'Paid', date: '2024-03-05' },
  { id: 2, student_id: 2, name: 'Bryan Alexander', month: 'Maret', amount: 500000, status: 'Unpaid', date: '-' }
];
